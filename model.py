...
def placeholder_inputs(batch_size, num_point, POINT_DIM):
...
def get_model(point_cloud, is_training, POINT_DIM, bn_decay=None):
    ...
    # CONV
    net = tf_util.conv2d(input_image, 64, [1,POINT_DIM], padding='VALID', stride=[1,1],
...
if __name__ == "__main__":
    with tf.Graph().as_default():
        a = tf.compat.v1.placeholder(tf.float32, shape=(32,NUM_POINT,POINT_DIM))
